<!-- mv_js_plugin_start -->
  ...
  <script type="text/javascript" src="js/jquery-zoomslider-master/dist/jquery.zoomslider.min.js"></script>
  ...
  <script src="js/snazzy-info-window-master/dist/snazzy-info-window.min.js"></script>
