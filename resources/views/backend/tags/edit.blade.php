...
<form method="post" enctype="multipart/form-data" action="{{ route('admin.tags.update', [$tag->id]) }}" class="form-horizontal" role="form">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    ...
    @include('backend/_layouts/forms/text', [
        ...
        'value'         => old("tw_category") ?: $tag->tw_category,
