...
<form method="post" enctype="multipart/form-data" action="{{ route('admin.blog_articles.update', [$blog_article->id]) }}" class="form-horizontal" role="form">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    ...
    @include('backend/_layouts/forms/datepicker', [
        ...
        'value'         => old("published_date")?: $blog_article->published_date,
    ...
    @include('backend/_layouts/forms/picture', [
        ...
        'delete_box'    => NULL,
        'upload_path'   => NULL,
        'value'         => asset('uploads/blog_articles/'.$picture = old("picture") ?: $blog_article->picture),
    ...
    @include('backend/_layouts/forms/text', [
        ...
        'value'         => old("tw_name") ?: $blog_article->tw_name,
    ...
    @include('backend/_layouts/forms/textarea', [
        ...
        'value'         => old("tw_intro") ?: $blog_article->tw_intro,
        ...
        'required'      => '',
        'error_message' => '',
        'value'         => old("tw_description") ?: $blog_article->tw_description,
        ...
        'value'         => old("link") ?: $blog_article->link,
